...
public class DragDropItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	public void OnPointerDown(PointerEventData eventData)
	{
		...
		//if this item is in a drop zone with allowExit set to false, don't allow drag
		if (transform.parent.CompareTag("Drop Zone"))
		{
	...
	{
		if(DragDropManager.instance == null || DragDropManager.instance.isReturning || DragDropManager.instance.current != this)
		{
			return;
		}
